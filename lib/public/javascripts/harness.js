  ...
  */
  ...
  module.exports = ListButton = (function() {
    ...
    function ListButton(params) {
      ListButton.__super__.constructor.call(this, params);
      this.render();
    }
    ListButton.prototype.render = function() {
      this.html('ListButton');
      return this;
    };
    return ListButton;
  })();
  ...
  var Button, RootTmpl, RootView, core;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  */
  module.exports = RootView = (function() {
    ...
    RootView.prototype.render = function() {
      var button, div, spec, tmpl, _i, _len, _ref, _results;
      tmpl = this.tmpl;
      this.html(tmpl.root());
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push(div.append(button.el));
      }
      return _results;
    };
    return RootView;
