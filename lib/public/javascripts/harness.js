...
(function(/*! Stitch !*/) {
  ...
  */
    ...
    init: function() {
      ...
      return suite.fetch({
        ...
        success: function(e) {
          ...
          return console.log('specs', suite.specs());
        }
      });
    }
  };
}).call(this);
}, "harness/app/models/suite": function(exports, require, module) {(function() {
  var Suite, core;
  ...
  core = require('core');
  module.exports = Suite = (function() {
    __extends(Suite, core.mvc.Model);
    function Suite(args) {
      Suite.__super__.constructor.apply(this, arguments);
      this.addProps({
        specs: []
      });
    }
    Suite.prototype.url = '/harness.json';
    return Suite;
  })();
}).call(this);
